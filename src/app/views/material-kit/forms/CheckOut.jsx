...
const CheckOut = () => {
    ...
    const getCart = async (id) => {
        try {
            fetch('https://sarestfullapi.onrender.com/client/getcart/' + id).then((response) => {
    ...
    const deleteCart = async (id) => {
        ...
        if (window.confirm("Are you sure you want to delete this product?"))
            try {
                fetch('https://sarestfullapi.onrender.com/client/deletecart/' + id, {
                    method: 'DELETE',
                    headers: {
    ...
    const updateProduct = async (id) => {
        if (window.confirm("Are you sure you want to update this product?"))
            try {
                fetch('https://sarestfullapi.onrender.com/client/updatecart/' + id, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    const getProduct = async (id) => {
        console.log(id);
        fetch('https://sarestfullapi.onrender.com/client/getcartbyid/' + id).then((response) => {
            response.json().then((result) => {
                console.log(result);
                setData(result);
    ...
    const checkOut = async (id) => {
        if (window.confirm("Are you sure you want to check out?"))
            try {
                fetch('https://sarestfullapi.onrender.com/client/checkout/' + id, {
                    method: 'POST',
