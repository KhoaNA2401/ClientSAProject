...
const OrderTable = () => {
    ...
    const getAllOrder = async () => {
        fetch('https://sarestfullapi.onrender.com/admin/getorder').then((response) => {
    ...
    const getProductDetails = async (id) => {
        ...
        for (let i = 0; i < arrayID.length; i++) {
            fetch('https://sarestfullapi.onrender.com/admin/getproducts/' + arrayID[i]).then((response) => {
                response.json().then((result) => {
    ...
    const handleAccept = (id) => {
        if (window.confirm("Are you sure you want to accept this order?"))
            try {
                fetch('https://sarestfullapi.onrender.com/admin/accpetcheckout', {
                    method: 'PUT',
                    headers: {
    ...
    const handleDelete = (id) => {
        if (window.confirm("Are you sure you want to delete this order?"))
            try {
                fetch('https://sarestfullapi.onrender.com/admin/deleteorder/' + id, {
                    method: 'DELETE',
                }).then((response) => {
                    response.json().then((result) => {
                        console.log(result);
