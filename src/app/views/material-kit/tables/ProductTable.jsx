...
const ProductTable = () => {
    ...
    const getAllProducts = async () => {
        fetch('https://sarestfullapi.onrender.com/admin/getall').then((response) => {
    ...
    const deleteProduct = async (id) => {
        ...
        if (window.confirm("Are you sure you want to delete this product?"))
            try {
                fetch('https://sarestfullapi.onrender.com/admin/deleteproducts/' + id, {
                    method: 'DELETE',
                    headers: {
    ...
    const updateProduct = async (id) => {
        if (window.confirm("Are you sure you want to update this product?"))
            try {
                fetch('https://sarestfullapi.onrender.com/admin/updateproducts/' + id, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    const getProduct = async (id) => {
        console.log(id);
        fetch('https://sarestfullapi.onrender.com/admin/getproducts/' + id).then((response) => {
            response.json().then((result) => {
                console.log(result);
                setData(result);
                setName(result.name);
