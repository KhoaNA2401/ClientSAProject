...
const CustomerTable = () => {
    ...
    const getAllCustomers = async () => {
        fetch('https://sarestfullapi.onrender.com/admin/getallcustomer').then((response) => {
    ...
    const deleteCus = async (id) => {
        ...
        if (window.confirm("Are you sure you want to delete this product?"))
            try {
                fetch('https://sarestfullapi.onrender.com/admin/deletecustomer/' + id, {
                    method: 'DELETE',
                    headers: {
    ...
    const getCusDetails = async (id) => {
        console.log(id);
        fetch('https://sarestfullapi.onrender.com/admin/getcustomer/' + id).then((response) => {
            response.json().then((result) => {
                console.log(result);
                setData(result);
